...
BOOST_FUSION_ADAPT_STRUCT(LogRequest, address, method, controller_path,
                          controller_method, request_body, request_head,
                          id_user, ip, user_agent, response_code, response_body,
                          response_head, time);
